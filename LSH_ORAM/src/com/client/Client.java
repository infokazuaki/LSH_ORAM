...
public class Client implements ClientInterface {
	 ...
	 */
	public static void sort4BitBlocks(short input) {
		// short input = (short) 0b1101010000111001;
		...
		System.out.printf("元のビット列: %16s%n",
				String.format("%16s", Integer.toBinaryString(input & 0xFFFF)).replace(' ', '0'));
		System.out.printf("ソート後ビット列: %16s%n",
				String.format("%16s", Integer.toBinaryString(result & 0xFFFF)).replace(' ', '0'));
				//この結果をLSHに渡す
	}
}